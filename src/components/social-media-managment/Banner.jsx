...
const Banner = () => {
    return (
        <div className="relative w-screen h-[calc(100vh-74px)] lg:h-[calc(100vh-80px)] xl:h-[calc(100vh-100px)] mx-auto">
            ...
            />
            <div className="absolute left-0 right-0 px-6 lg:px-0 text-left top-[16%] md:top-[16%] font-plus-jakarta-sans md:text-center space-y-4 lg:space-y-6 xl:space-y-9 z-20">
