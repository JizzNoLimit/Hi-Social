...
const OurSuccessProject = () => {
    return (
        <div className="relative w-full px-32 xl:px-0 bg-[#B8E0FF] overflow-hidden">
            ...
            <div className="relative max-w-[1180px] w-full mx-auto pt-16 pb-10 z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-5 py-8">
                    <div className="space-y-5 p-4 text-right bg-white rounded-tl-xl">
                    ...
                    <div className="space-y-5 p-4 text-right bg-white">
                        <div className="rounded-lg overflow-hidden">
                    ...
                    <div className="space-y-5 p-4 text-right bg-white rounded-tr-xl">
                        <div className="rounded-lg overflow-hidden">
                    ...
                    <div className="space-y-5 p-4 text-right bg-white rounded-bl-xl">
                        <div className="rounded-lg overflow-hidden">
                    ...
                    <div className="space-y-5 p-4 text-right bg-white rounded-br-xl">
                        <div className="rounded-lg overflow-hidden">
