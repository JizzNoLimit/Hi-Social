...
const SocialMediaStrategy = () => {
    return (    
        <div className="px-32 xl:px-0">
            <div className="flex items-center gap-6 max-w-[1180px] w-full mx-auto py-10">
                ...
                <div className="flex-1 text-right">
                    ...
                    <p className="mt-4 xl:mt-5 pl-8 text-lg xl:text-2xl">We'll work closely with you to develop a comprehensive social media strategy aligned with your business objectives.</p>
