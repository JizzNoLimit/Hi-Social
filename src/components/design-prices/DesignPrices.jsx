...
const DesignPrices = () => {
    return (
        <div className="w-full px-32 xl:px-0 py-10">
            <div className="max-w-[1180px] w-full mx-auto">
                ...
                <div className="my-8 bg-white drop-shadow-[0px_5px_20px_rgba(0,0,0,0.10)] rounded-xl overflow-hidden ">
                    <div className="flex gap-4">
                        <div className="group flex-1 px-10 pt-16 pb-10 text-center hover:text-white hover:bg-p-normal hover:rounded-bl-xl hover:rounded-br-xl">
                            <h4 className="text-xl xl:text-2xl font-bold text-p-normal group-hover:text-white">HiBronze</h4>
                            <p className="mt-3 text-2xl font-bold">IDR 1.500.000</p>
                            <p className="text-sm text-[#4B5768] group-hover:text-[#E6EAEC]">/ Month</p>
                        ...
                        <div className="group flex-1 px-10 pt-16 pb-10 text-center bg-p-normal text-white hover:bg-p-normal rounded-bl-xl rounded-br-xl">
                    ...
                    <div className="flex px-10 pt-20 pb-11">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="mt-4 text-[#6FBFFF]">
                                <div className="flex pt-2 text-center font-semibold border-b border-b-[#D9EEFF]">
                                ...
                                <div className="flex pt-2 pb-2 text-center font-semibold border-b border-b-[#D9EEFF]">
                                    <h4 className="flex justify-center flex-1 h-[17px] opacity-60"><img src={check_circle} alt="icon check" /></h4>
                                    <h4 className="flex justify-center flex-1 h-[17px]"><img src={check_circle} alt="icon check" /></h4>
                                    <h4 className="flex justify-center flex-1 h-[17px] opacity-60"><img src={check_circle} alt="icon check" /></h4>
                                </div>
                                <div className="flex pt-2 pb-2 text-center font-semibold border-b border-b-[#D9EEFF]">
                                    <h4 className="flex justify-center flex-1 h-[17px] opacity-60"><img src={check_circle} alt="icon check" /></h4>
